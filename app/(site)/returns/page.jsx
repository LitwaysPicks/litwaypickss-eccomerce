    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
          We want you to love every purchase. If something isn't right, we make
          the return process simple and hassle-free.
        </p>
      </div>
        ...
        {[
          {
            ...
            title: "7-Day Window",
            description:
              "You have 7 days after receiving your item to request a return.",
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="card-elevated p-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            We offer a <strong>7-day return policy</strong>. You have 7 days
            after receiving your item to request a return. Returns requested
        ...
        <div className="card-elevated p-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-5">
            ...
            of the outcome. Here's how the process works:
          </p>
            ...
            {[
              {
                ...
                desc: "Contact us within 7 days of receiving your order via phone or WhatsApp.",
              },
              {
                step: "2",
                label: "Ship Item Back",
                desc: "Send the item back in its original condition and packaging.",
              },
              {
                step: "3",
                label: "Inspection",
                desc: "We inspect the returned item and notify you of the outcome within 1 business day.",
              },
              {
                step: "4",
                label: "Refund Issued",
                desc: "If approved, a refund is issued to your original payment method within 3 business days.",
              },
            ].map((s) => (
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
              ...
              <p className="text-yellow-800 text-sm leading-relaxed">
                <strong>Customer pays return shipping</strong> unless the item
                arrived damaged, defective, or is incorrect.
              </p>
            </div>
            <div className="flex items-start gap-3 p-4 bg-green-50 border border-green-200 rounded-xl">
              <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 shrink-0" />
              <p className="text-green-800 text-sm leading-relaxed">
                <strong>We cover return shipping</strong> if your item arrived
                damaged, defective, or you received the wrong item. Contact us
                and we'll arrange pickup.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="card-elevated p-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            To initiate a return, contact our customer support team. Please have
            your order details ready.
          </p>
