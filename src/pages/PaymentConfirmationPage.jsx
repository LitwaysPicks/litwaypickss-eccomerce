...
export default function PaymentConfirmationPage() {
  ...
  // Fix #13: fall back to sessionStorage if location.state is lost on refresh
  const order =
    location.state ||
    (() => {
      try {
  ...
  useEffect(() => {
    ...
    if (order) {
      ...
      const timer = setTimeout(() => navigate("/shop"), 8000);
                ...
                {order.pointsEarned && (
                  <div className="bg-purple-50 rounded-lg p-4 mt-4">
                    ...
                    <p className="text-sm text-purple-600 mt-2">
                      Use your points on your next purchase for amazing
                      discounts!
                    </p>
                  </div>
                )}
